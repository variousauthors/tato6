...
for i, ore in ores {
  val dust = dusts[i];
  Mortar.addRecipe('tato6-roots-mortar-dusts-' + i, dust, [ore]);
}
...
Mortar.addRecipe('tato6-roots-mortar-blaze-powder', <minecraft:blaze_powder> * 3, [<minecraft:blaze_rod>]);
Mortar.addRecipe('tato6-roots-mortar-string', <minecraft:string> * 2, [<minecraft:wool>]);
