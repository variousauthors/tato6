...
mods.rustic.CrushingTub.addRecipe(bloodLiquid * 500, null, <quark:glass_shards>);
...
val devilWeed = <biomesoplenty:plant_1:7>;

val aconitumSeed = <bewitchment:aconitum_seeds>;
val belladonnaSeed = <bewitchment:belladonna_seeds>;
val garlicSeed = <bewitchment:garlic_seeds>;
val helleboreSeed = <bewitchment:hellebore_seeds>;
val mandrakeSeed = <bewitchment:mandrake_seeds>;
val whitesageSeed = <bewitchment:white_sage_seeds>;
val wormwoodSeed = <bewitchment:wormwood_seeds>;

// add bewitchment seeds to devil's grass
Dropt.list("list_name")
  .add(Dropt.rule()
      .matchBlocks(["biomesoplenty:plant_1:7"])
      .replaceStrategy("ADD")
      .addDrop(Dropt.drop()
