...
mods.mekanism.enrichment.addRecipe(goldOre, <mekanism:dust:1> * 2);
...
mods.mekanism.chemical.injection.addRecipe(silverOre, <gas:hydrogenchloride>, <mekanism:shard:5> * 4);
mods.mekanism.chemical.injection.addRecipe(tinOre, <gas:hydrogenchloride>, <mekanism:shard:4> * 4);

mods.mekanism.chemical.dissolution.addRecipe(goldOre, <gas:gold> * 1000);
mods.mekanism.chemical.dissolution.addRecipe(silverOre, <gas:silver> * 1000);
mods.mekanism.chemical.dissolution.addRecipe(tinOre, <gas:tin> * 1000);
